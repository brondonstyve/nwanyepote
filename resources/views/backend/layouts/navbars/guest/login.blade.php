<nav
    ...
    <div class="container-fluid">
        <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="{{ route('dashboard') }}">
            <img src="{{asset('/assets-admin/img/logo-ct.png')}}" width="10%" class="navbar-brand-img h-100" alt="...">
            <br>
            Administration
        </a>
        ...
        <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav mx-auto">
                ...
                @endif
                <li class="nav-item">
                    <a class="nav-link text-dark me-2" href="{{ auth()->user() ? route('sign-in') : route('login-admin') }}">
