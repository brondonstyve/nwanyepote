<div>
    <div class="container-fluid">
        <div class="page-header min-height-300 border-radius-xl mt-4"
            style="background-image: url({{asset('/assets-admin/img/curved-images/curved0.jpg')}}); background-position-y: 50%;">
            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="{{asset('/assets-admin/img/bruce-mars.jpg')}}" alt="..." class="w-100 border-radius-lg shadow-sm">
                        <a href="javascript:;"
