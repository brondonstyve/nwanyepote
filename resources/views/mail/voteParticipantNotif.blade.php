                            ...
                            <tbody>
                                <tr>
                                    <td style="padding:15px;color:#333;font-size:16px;font-family:sans-serif">
                                        ...
                                        <p>Bonjour,</p>
                                        <p>Vous venez de demander à participer à un évènement chez NWANYEPOTE. Votre candidature est en cours d'étude. une fois une décision prise vous seriez notifiez par email.</p>
                                        <p><a href=" {{route('detail-evenement-participatif',$detail['id_event'])}}">Consultuer l'événement'</a></p>
                                        <p>-------------------------------------------------------------------------------</p>
