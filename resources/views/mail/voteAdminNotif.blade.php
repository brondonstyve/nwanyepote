                            ...
                            <tbody>
                                <tr>
                                    <td style="padding:15px;color:#333;font-size:16px;font-family:sans-serif">
                                        ...
                                        <p>Bonjour,</p>
                                        <p>Un nouvel utilisateur vient de demander à participer à un événement. Veuillez cliquer sur le lien ci dessous pour consulter la candidature de ce dernier.</p>
                                        <p><a href=" {{route('admin-participant',$detail['id_event'])}}">Consultuer la candidature</a></p>
                                        <p>-------------------------------------------------------------------------------</p>
