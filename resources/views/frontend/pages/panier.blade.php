    ...
    <div class="container pt-12 pt-md-14 pb-14 pb-md-16">
        <div class="row gx-md-8 gx-xl-12 gy-12">
            <div class="col-lg-8 mx-auto text-center">
                <h3>Veuillez vous connecter pour acceder aux données de votre panier. Si vous n'avez pas de compte, cliquez <a href="{{route('signin')}}">ici pour creér un compte</a></h3>
            </div>
        </div>
    </div>
</section>
