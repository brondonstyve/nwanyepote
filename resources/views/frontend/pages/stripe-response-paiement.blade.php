...
<div class="section mt-3">
    ...
    <div class="container">
        <!-- row -->
        <div class="row">
                    <div class="custom-alerts alert alert-success  in">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button>
                        Votre paiement par carte a été éffectué avec succès. Consultez la page <a href="{{route('commande')}}">Commande</a> pour avoir le détail et le suivi de vos commandes.                    </div>
