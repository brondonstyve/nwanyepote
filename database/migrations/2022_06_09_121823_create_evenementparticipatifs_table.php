...
class CreateEvenementparticipatifsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('evenementparticipatifs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('evenementparticipatifs');
    }
}
